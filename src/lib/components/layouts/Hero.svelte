<script lang="ts">
	...
	import type { BulmaHelper, Colors, HeroSize } from '$lib/utils/bulma.types.js';
	...
	export let size: HeroSize | undefined = undefined;
	export let isFullHeightWithNavbar: boolean = false;
...
<section class={cls}>
	<slot {HeroHead} {HeroBody} {HeroFoot} />
</section>
