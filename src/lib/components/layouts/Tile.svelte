<script lang="ts">
	...
	import type { BulmaHelper, TileType, TileSize, TileLayout } from '$lib/utils/bulma.types.js';
	...
	export let size: TileSize | undefined = undefined;
	export let layout: TileLayout = 'horizontal';
