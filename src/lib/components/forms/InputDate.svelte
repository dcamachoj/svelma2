<script lang="ts">
	...
	import type { BulmaHelper, Colors, InputSize } from '$lib/utils/bulma.types.js';
	import { getFormatter } from '$lib/utils/format.js';
	import { getNopUse, type Action } from '$lib/utils/validators.js';
